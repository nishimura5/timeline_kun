...
uv run pyinstaller --onefile --windowed --clean --path src --collect-all timeline_kun -n TimelineKunTimer --version-file=app.version --hidden-import winrt.windows.foundation.collections ./scripts/launch_timer.py
